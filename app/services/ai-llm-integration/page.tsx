...
const service = getServiceBySlug("ai-llm-integration");
...
export const metadata: Metadata = {
  ...
  alternates: { canonical: `https://logicbevers.com/services/ai-llm-integration` },
};

export default function AILLMIntegrationPage() {
  if (!service) notFound();
