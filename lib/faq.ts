...
export const faqs: FAQ[] = [
  ...
  {
    question: "How do you handle cybersecurity for Growing Businesses?",
    answer:
  ...
  },
  {
    ...
    answer:
      "Our pricing is customized based on your company size, the number of users and devices, and the services you need. Most Growing Businesses (10–50 employees) see costs significantly lower than hiring in-house IT staff, with the added benefit of enterprise-grade expertise. Contact us for a free quote.",
  },
];
